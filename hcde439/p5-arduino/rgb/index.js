...
function draw() {
  ...
  const red = round(map(Number(rgbArray[0]), 658, 679, 0, 255));
  const green = round(map(Number(rgbArray[1]), 658, 679, 0, 255));
  const blue = round(map(Number(rgbArray[2]), 658, 679, 0, 255));  
